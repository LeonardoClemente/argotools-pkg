...
# GOOGLE CORRELATE VARIABLES
GMAIL_LOGIN_URL = 'https://accounts.google.com/signin/v2/identifier?continue=https%3A%2F%2Fmail.google.com%2Fmail%2F&service=mail&sacu=1&rip=1&flowName=GlifWebSignIn&flowEntry=ServiceLogin'

GC_AVAILABLE = ['AR', 'AU', 'AT', 'BE', 'BR', 'BG', 'CA', 'CL', 'CN', 'CO', 'HR', 'CZ', 'DK',\
 'EG', 'FI', 'FR', 'DE', 'GR', 'HU', 'IN', 'ID', 'IE', 'IL', 'IT', 'JP', 'MY', \
 'MX', 'MA', 'NL', 'NZ', 'NO', 'PE', 'PH', 'PL', 'PT', 'RO', 'RU', 'SA', 'SG',\
 'ES', 'SE', 'CH', 'TW', 'TH', 'TR', 'UA', 'UK', 'US']




# SINAVE VARIABLES
SINAVE_LOGIN_URL = 'http://influenza.rhove.gob.mx/influenza/'
SINAVE_REPORT_URL = 'http://influenza.rhove.gob.mx/influenza/rpt_general.php'


#INMET VARIABLES

# WORLD COUNTRY CODES
WORLD_COUNTRIES = ['Afghanistan', 'Åland Islands', 'Albania', 'Algeria',
...
WORLD_COUNTRIES_CODE_2 = ['AF', 'AX', 'AL', 'DZ', 'AS', 'AD', 'AO', 'AI', 'AQ', 'AG', 'AR',
...
CODE_DICT = dict(zip(WORLD_COUNTRIES_CODE_2, WORLD_COUNTRIES))
